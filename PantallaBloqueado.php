...
$_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'BLOQUEADO'] = 'SI';

if (isset($_SESSION[$_SESSION['SISTEMA_SIGLA'].'RIF_VENTA'])) {
	$LOGIN = $_SESSION[$_SESSION['SISTEMA_SIGLA'].'RIF_VENTA'];
} else {
        ...
        <div>
            ...
            <form class="m-t" role="form"  id="FromInicioSesion">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="Clave" required id="CLAVE" value="">
                </div>
                <div class="form-group">
					<button type="submit" class="btn btn-w-m btn-success block full-width m-b">Desbloquear</button>
				</div>
                <div class="form-group">
