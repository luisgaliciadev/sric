...
<head>
    <title>SRIC - Corporación Cyber Power S.A.C</title>
	...
	<!-- Icono Logo Sistema -->
	<link href="Includes/Imagenes/sistema_logo.ico" type="image/x-icon" rel="icon">
	<!-- Loading -->
...
<body class=" skin-1  <?php echo $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'SISTEMA_NO_CONFIG']; ?>  <?php echo $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'SISTEMA_BOXED']; ?> fixed-footer">
		...
		<div id="wrapper">
			...
			<div id="page-wrapper" class="gray-bg">
						...
						<ul class="nav navbar-top-links navbar-left">
							<li style="padding-top:20px;">
								<span class="text-white">
									<strong>SRIC <?php echo $cadUsuVentas;?></strong>
								</span>
							</li>
						</ul>
				...
				<div class="footer">
					...
					<div>
						<strong>Copyright  &copy; <?php if (date("Y") == 2018) {
																															echo "" . date("Y");
																														} else {
																															echo "2018-" . date("Y");
																														} ?>. Coporpación Cyber Power S.A.C			</div>
				</div>
			</div>
		</div>
	</div>
