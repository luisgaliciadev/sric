		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/clientes/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/clientes/FormNuevo.php', 'Registrar cliente');
			}
			
			function callFormModificar(ID){
				window.parent.parent.Cargando(1);

				vModal('Sistema/clientes/formModificar.php?&ID='+ID, 'Modificar cliente');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Est&aacute seguro de anular este cliente!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/clientes/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
			...
			function activar(ID) {
				swal({
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/clientes/ScriptActivar.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
