		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Equipos/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Equipos/FormNuevo.php', 'Registrar Equipo');
			}
			
			function callFormModificar(ID){
				window.parent.parent.Cargando(1);

				vModal('Sistema/Equipos/formModificar.php?&ID='+ID, 'Modificar Equipo');
			}	
			...
			function anular(ID) {
				swal({
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Equipos/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
			...
			function activar(ID) {
				swal({
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Equipos/ScriptActivar.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
