...
$titulosColumnas = array ('NRO.','TIPO DOCUMENTO',' NOMBRE LOCALIDAD', 'SERIE', 'NRO. CONTROL', 'NRO. DOCUMENTO', 'ESTATUS', 'FECHA EMISION', 'RIF CLIENTE', 'NOMBRE CLIENTE','DOC. AFECTADO', 'TIPO MONEDA DOCUMENTO', 'FECHA DE ANULACION', 'CONDICION PAGO','MONTO GRAVADO','MONTO NO GRAVADO','ALICUOTA IVA','MONTO IVA', 'SUB-TOTAL','MONTO TOTAL');
   ...
   $ResultadoEjecutar=$conector->Ejecutar($vSQL, $INSERT_MAYUSCULA="SI", $SP_BITACORA='NO', $SP_ACCION='', $SP_NB_TABLA='', $SP_VALOR_CAMPO_ID='');
    ...
    {    
		...
		{ 
            ...
            ->setCellValue('M'.$i, utf8_encode(odbc_result($resul,'F_ANULACION')))
