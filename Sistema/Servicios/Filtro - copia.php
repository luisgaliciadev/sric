	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<script>		
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Servicios/FormNuevo.php', 'Registrar Servicio');
			}
			
			function callFormModificar(ID){
				window.parent.parent.Cargando(1);

				vModal('Sistema/Servicios/formModificar.php?&ID='+ID, 'Modificar Servicio');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Est&aacute seguro de anular este Servicio!",
					type: "warning",
			...
			function activar(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Est&aacute seguro de activar este Servicio!",
					type: "warning",
					showCancelButton: true,
					confirmButtonColor: "#DD6B55",
					confirmButtonText: "Aceptar",
