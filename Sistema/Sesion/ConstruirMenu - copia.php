...
if (isset($_SESSION[$SISTEMA_SIGLA . "LOGIN"])) {
	...
	$NB_LOCALIDAD = $_SESSION[$SISTEMA_SIGLA . "NB_LOCALIDAD"];
		...
		$Menu = '
					<li class="nav-header">
						<div class="dropdown profile-element">
							...
							<?php /*?><ul class="dropdown-menu animated fadeInRight m-t-xs">
								<li><a href="javascript:" onClick="vModal3(\'Sistema/Sesion/FormModificar.php\', \'Modificar mis datos\');">Modificar mis datos</a></li><?php */?>
