...
$vSQL = "EXEC SP_CREAR_USUARIO '$LOGIN', '$RAZON_SOCIAL', '$DIRECCION', '$TLF', '$EMAIL', '$CLAVE';";
					...
					<table cellpadding="0" cellspacing="0" width="600" class="w320">
					  <tr>
						<td align="left" class="mobile-padding" style="padding:20px">
						  ...
						  <br>
						  <p>
							Hola ' . $RAZON_SOCIAL . ', ya se creó tu cuenta:                  
						  </p>
						  <br>
						  <p>
						  ...
						  <br>
						  <p>
							A partir de ahora puedes ingresar a nuetra app SIF.                  
						  </p>
						  <br>                    
						  <br>  
						</td>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
					  <tr>
						<td valign="top" class="mobile-padding" style="padding:20px;"><table cellspacing="0" cellpadding="0" width="100%">
						  <tr>
							  <td style="padding-top:50px;">Bolivariana de Puertos, S.A. y app SIF para optimizar las solicitudes de servicios.</td>
							</tr>
						</table>
						</td>
					  </tr>
...
if ($CONEXION == "SI" and $ERROR == "NO") {
	...
	if ($RESULTADO == 1) {
		...
		$ArregloEnviarCorreo = EnviarCorreo(
			...
			$Asunto = 'Registro realizado exit&oacutesamente, ' . $RAZON_SOCIAL,
		...
		if (!$ArregloEnviarCorreo["RESULTADO"]) {
			$ERROR = "SI";
			$Arreglo["MSJ_ERROR"] = "Error de env&iacuteo de correo: " . $ArregloEnviarCorreo["MSJ_ERROR"];
		}
	}
