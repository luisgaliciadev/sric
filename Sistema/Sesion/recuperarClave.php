...
if ($CONEXION == "SI" and $ERROR == "NO") {
	...
	if ($RESULTADO == 1) {
							...
							<table cellpadding="0" cellspacing="0" width="600" class="w320">
							  <tr>
								<td align="left" class="mobile-padding" style="padding:20px">
								  ...
								  <br>
								  <p>
									Hola ' . $RAZON_SOCIAL . ', la recuperacion de contraseña se ha realizado exitosamente:                  
								  </p>
								  <br>
								  <p>
		...
		$ArregloEnviarCorreo = EnviarCorreo(
			...
			$Asunto = 'Recuperaci&oacuten de clave realizada exit&oacutesamente, ' . $RAZON_SOCIAL,
