					...
					<div class="ibox-content">
						<form class="m-t" role="form" id="FromInicioSesion">
							...
							<div class="form-group">
								<input name="LOGIN" type="text" required class="form-control" placeholder="Login" id="LOGIN" <?php /*?>style="text-transform:uppercase;<?php */?>" autocomplete="off" value="">
							</div>
							<div class="form-group">
								<input type="password" class="form-control" placeholder="Password" required id="CLAVE" name="CLAVE" value="">
							</div>

							<button type="submit" class="btn btn-w-m btn-success block full-width m-b">Ingresar</button>
